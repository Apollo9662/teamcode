...
import static org.firstinspires.ftc.teamcode.AutoBlue.stonePositionNewMoves.*;
...
//        robot.horizontalElevator.setPower(0);
    ...
    public stonePositionNewMoves vufria(){
        pidDrive(0.3,35,0,normal);
        if (vuforia.procces() != 10000) {
            return LEFT;
        }
        pidDrive(0.3,17 ,0,left);
        sleep(400);
        if (vuforia.procces() != 10000) {
            return CENTER;
        }
    ...
    public void newRight(){
        ...
        robot.backClaw.setPosition(1);
        pidTurn(0.4,90);
        pidDrive(0.35,-10,90,normal);
        pidDrive(0.35,60,90,right);
