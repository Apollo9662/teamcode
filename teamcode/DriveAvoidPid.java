...
public class DriveAvoidPid extends LinearOpMode
{
    ...
    double                  globalAngle, power = 0.70, correction, rotation;
    boolean                 aButton, bButton;
    PIDController           pidRotate, pidDrive, pidDriveEncoder;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        pidDriveEncoder.setSetpoint(1600);
        ...
        while (opModeIsActive()){
            ...
            if (rightMotor.getCurrentPosition() < 1500 || rightMotor.getCurrentPosition() > 1700) {
                power = pidDriveEncoder.performPID(rightMotor.getCurrentPosition());
            }
            else {
                power=0;
            }
